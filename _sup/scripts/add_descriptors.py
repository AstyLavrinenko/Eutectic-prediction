...
class descriptors:
    ...
    def add_selected_features(self, df):
        features = ['Component#1','Smiles#1','Component#2','Smiles#2','PD','Type','groups','T_EP',
                    'X#1','T#1','T#2','lny','MolWeight#2','SpherocityIndex','RadiusOfGyration',
